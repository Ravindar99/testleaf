...
public abstract class Reporter extends DriverInstance {
	...
	public abstract long takeSnap(); //already declared variable, a doubt here

	public void reportStep(String desc, String status, boolean bSnap) {
		synchronized (test) {

			// Start reporting the step and snapshot
			MediaEntityModelProvider img = null; //helps in creating screenshot first null value to not take a screenshot 
			...
			{
				long snapNumber = 100000L; //to save snap name in long integer value
				snapNumber = takeSnap();//above abstract long variable,  also calling the overrided method in selenium base
				try {
